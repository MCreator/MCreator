...
bannerFile="${settings.getModID()}:textures/${settings.getModPicture()}.png"
</#if>
<#if settings.getModIcon()?has_content>
iconFile="${settings.getModID()}:textures/${settings.getModIcon()}.png"
</#if>
