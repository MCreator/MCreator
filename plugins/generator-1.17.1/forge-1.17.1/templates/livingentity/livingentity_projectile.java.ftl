...
@OnlyIn(value = Dist.CLIENT, _interface = IRendersAsItem.class) private static class ${name}ProjectileEntity extends AbstractArrowEntity implements IRendersAsItem {
