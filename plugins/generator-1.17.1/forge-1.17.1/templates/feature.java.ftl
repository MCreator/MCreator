...
public class ${name}Feature extends
	...
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE =
	    <#if data.generationType == "Ore">
	        FEATURE.configured(new OreConfiguration(${name}FeatureRuleTest.INSTANCE, ${mappedBlockToBlockStateCode(data.blockToGenerate)}, ${data.frequencyOnChunk}))
