if(world instanceof World && !world.getWorld().isRemote && ${input$entity} instanceof LivingEntity){
	<#if field$rangeditem?has_content && field$rangeditem != "Arrow">
		${field$rangeditem}Item.shoot(world.getWorld(), (LivingEntity) ${input$entity}, new Random(), (float) ${input$speed}, (float) ${input$damage}, (int) ${input$knockback}, (float) ${input$pitch}, (float) ${input$yaw});
	<#else>
