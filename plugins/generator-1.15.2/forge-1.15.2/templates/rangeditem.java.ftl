...
<#macro arrowShootCode>
	...
	ArrowCustomEntity entityarrow = shoot(world, entity, random, ${data.bulletPower}f, ${data.bulletDamage}, ${data.bulletKnockback}, entity.rotationPitch, entity.rotationYaw);
