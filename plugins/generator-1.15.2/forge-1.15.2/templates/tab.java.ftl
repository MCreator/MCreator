...
public class ${name}ItemGroup extends ${JavaModName}Elements.ModElement{

	public ${name}ItemGroup (${JavaModName}Elements instance) {
		super(instance, ${data.getModElement().getSortID()});
	}

	@Override public void initElements() {
		tab = new ItemGroup("tab${registryname}") {
			...
			@OnlyIn(Dist.CLIENT) public boolean hasSearchBar() {
				return ${data.showSearch};
         		...
         		<#elseif data.bgTexture?has_content>.setBackgroundImageName("${data.bgTexture}")</#if>;
	}
