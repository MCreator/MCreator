...
<#macro procedureToRetvalCodeTwo name dependencies type customVals={}>
...
<#macro procedureOBJToItemstackCode object="">
    <#if object?? && object?has_content && object.getName() != "null">
        <@procedureToRetvalCodeTwo name=object.getName() dependencies=object.getDependencies(generator.getWorkspace()) type="ItemStack" />
    <#else>
        ItemStack.EMPTY
    </#if>
</#macro>
