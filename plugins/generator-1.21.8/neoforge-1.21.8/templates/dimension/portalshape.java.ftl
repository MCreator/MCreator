...
public class ${name}PortalShape ${mcc.getClassBody("net.minecraft.world.level.portal.PortalShape")
        ...
        .replace("blockstate.is(Blocks.NETHER_PORTAL)", "blockstate.getBlock() == " + JavaModName + "Blocks." + REGISTRYNAME + "_PORTAL.get()")
        .replace("p_77718_.is(BlockTags.FIRE) || p_77718_.is(Blocks.NETHER_PORTAL)", "p_77718_.getBlock() == " + JavaModName + "Blocks." + REGISTRYNAME + "_PORTAL.get()")
