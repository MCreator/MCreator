Данное поле предоставляет оценку площади поверхности Верхнего мира, покрываемой этим биомом. Расчёт корректен для значений от -1 до 1, поскольку этот диапазон используется биомами Верхнего мира.
