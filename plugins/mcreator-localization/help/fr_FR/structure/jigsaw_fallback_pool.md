Ce paramètre détermine quel bassin de bloc de puzzle peut être utilisé comme une solution de secours pour terminer la structure (partie de bloc de structure terminale).
