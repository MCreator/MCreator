...
public class GameEventEntry extends MappableElement {
	...
	public GameEventEntry(@Nonnull Workspace owner, String name) {
		super(new NameMapper(owner, "gameevents"), name);
	}

	public GameEventEntry(@Nonnull Workspace owner, DataListEntry name) {
