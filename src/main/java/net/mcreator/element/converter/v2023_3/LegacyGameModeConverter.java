...
public class LegacyGameModeConverter extends ProcedureConverter {
	...
	@Override protected String fixXML(Procedure procedure, String xml) {
		return xml.replace("<field name=\"gamemode\">NOT_SET</field>", "<field name=\"gamemode\">SURVIVAL</field>");
	}
