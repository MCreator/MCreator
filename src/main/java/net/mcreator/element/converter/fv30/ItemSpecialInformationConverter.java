...
public class ItemSpecialInformationConverter implements IConverter {

	@Override
	public GeneratableElement convert(Workspace workspace, GeneratableElement input, JsonElement jsonElementInput) {
		Item item = (Item) input;
		JsonObject oldItem = jsonElementInput.getAsJsonObject().getAsJsonObject("definition");

		List<String> specialInfo = new ArrayList<>();
		if (oldItem.get("specialInfo") != null)
			oldItem.getAsJsonArray("specialInfo").iterator()
