...
public class StructureDimensionRestrictionConverter implements IConverter {

	private static final Logger LOG = LogManager.getLogger("StructureDimensionRestrictionConverter");
	...
	public GeneratableElement convert(Workspace workspace, GeneratableElement input, JsonElement jsonElementInput) {
		try {
			...
			if (jsonElementInput.getAsJsonObject().get("definition").getAsJsonObject().get("spawnWorldTypes") != null) {
				...
				if (structure.restrictionBiomes.isEmpty())
					structure.restrictionBiomes = restrictionBiomes;
			} else {
