...
import net.mcreator.element.converter.v2023_3.EntitiesRangedAttackConverter;
...
public class ConverterRegistry {
	...
	private static final Map<ModElementType<?>, List<IConverter>> converters = new HashMap<>() {{
		...
		put(ModElementType.PROCEDURE, List.of(new ProcedureEntityDepFixer(), new OpenGUIProcedureDepFixer(),
				...
				new ToolToItemTypeProcedureConverter(), new ExplodeProcedureConverter(), new ProcedureArrowProjectileFixer()));
