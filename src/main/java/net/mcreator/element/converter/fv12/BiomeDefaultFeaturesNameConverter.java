...
public class BiomeDefaultFeaturesNameConverter implements IConverter {
	private static final Logger LOG = LogManager.getLogger(BiomeDefaultFeaturesNameConverter.class);
