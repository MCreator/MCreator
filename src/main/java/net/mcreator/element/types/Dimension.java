...
@SuppressWarnings("unused") public class Dimension extends GeneratableElement
	...
	@NumericParameter(init = 63, min = -1024, max = 1024, step = 1) public int seaLevel;
	...
	@NumericParameter(init = 192, min = -2032, max = 2031, step = 16) public int cloudHeight;
	public String skyType;
	public Color airColor;
	public boolean sunHeightAffectsFog;
	public boolean canRespawnHere;
	public boolean hasFog;
	@NumericParameter(init = 0, min = 0, max = 1, step = 0.01) public double ambientLight;
	public boolean doesWaterVaporize;
	public boolean hasFixedTime;
	@NumericParameter(init = 0, min = 0, max = 24000, step = 1) public int fixedTimeValue;
	@NumericParameter(init = 1, min = 0.01, max = 1000, step = 0.01) public double coordinateScale;
	...
	@NumericParameter(init = 0, min = 0, max = 15, step = 1) public int minMonsterSpawnLightLimit;
	@NumericParameter(init = 7, min = 0, max = 15, step = 1) public int maxMonsterSpawnLightLimit;
	@NumericParameter(init = 0, min = 0, max = 15, step = 1) public int monsterSpawnBlockLightLimit;
	...
	@NumericParameter(init = 0, min = 0, max = 15, step = 1) public int portalLuminance;
