...
@SuppressWarnings({ "unused", "NotNullFieldNotInitialized" }) public class LivingEntity extends GeneratableElement
	...
	public int spawnPercentageRaidOne;
	public int spawnPercentageRaidTwo;
	public int spawnPercentageRaidThree;
	public int spawnPercentageRaidFour;
	public int spawnPercentageRaidFive;
	public int spawnPercentageRaidSix;
	public int spawnPercentageRaidSeven;
