...
@SuppressWarnings({ "unused", "NotNullFieldNotInitialized" }) public class Tool extends GeneratableElement
	...
	@NumericParameter(init = 4, min = 0, max = 128000, step = 0.5) public double efficiency;
	@NumericParameter(init = 1, min = 0, max = 100, step = 0.1) public double attackSpeed;
	@NumericParameter(init = 2, min = 1, max = 128000, step = 1) public int enchantability;
	@NumericParameter(init = 4, min = 0, max = 128000, step = 0.1) public double damageVsEntity;
	@NumericParameter(init = 100, min = 0, max = 128000, step = 1) public int usageCount;
