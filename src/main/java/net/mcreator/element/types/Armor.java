...
@SuppressWarnings("unused") public class Armor extends GeneratableElement implements IItem, ITabContainedElement {
	...
	@NumericParameter(init = 15, min = 0, max = 1024, step = 1) public int maxDamage;
	@NumericParameter(init = 2, min = 0, max = 1024, step = 1) public int damageValueHelmet;
	@NumericParameter(init = 6, min = 0, max = 1024, step = 1) public int damageValueBody;
	@NumericParameter(init = 5, min = 0, max = 1024, step = 1) public int damageValueLeggings;
	@NumericParameter(init = 2, min = 0, max = 1024, step = 1) public int damageValueBoots;
	@NumericParameter(init = 9, min = 1, max = 128000, step = 1) public int enchantability;
	@NumericParameter(init = 0, min = 0, max = 1024, step = 0.1) public double toughness;
	@NumericParameter(init = 0, min = 0, max = 5.0, step = 0.1) public double knockbackResistance;
