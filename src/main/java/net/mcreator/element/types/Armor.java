...
@SuppressWarnings("unused") public class Armor extends GeneratableElement implements IItem, ITabContainedElement {
	...
	@NumericParameter(defaultValue = 15, min = 0, max = 1024, step = 1) public int maxDamage;
	@NumericParameter(defaultValue = 2, min = 0, max = 1024, step = 1) public int damageValueHelmet;
	@NumericParameter(defaultValue = 6, min = 0, max = 1024, step = 1) public int damageValueBody;
	@NumericParameter(defaultValue = 5, min = 0, max = 1024, step = 1) public int damageValueLeggings;
	@NumericParameter(defaultValue = 2, min = 0, max = 1024, step = 1) public int damageValueBoots;
	@NumericParameter(defaultValue = 9, min = 1, max = 128000, step = 1) public int enchantability;
	@NumericParameter(defaultValue = 0, min = 0, max = 1024, step = 0.1) public double toughness;
	@NumericParameter(defaultValue = 0, min = 0, max = 5.0, step = 0.1) public double knockbackResistance;
