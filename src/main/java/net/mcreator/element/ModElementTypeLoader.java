...
public class ModElementTypeLoader {
	...
	public static void loadModElements() {
		...
		ModElementType.ARMORTRIM = register(new ModElementType<>("armortrim", null, ArmorTrimGUI::new, ArmorTrim.class)).coveredOn(GeneratorFlavor.gamePlatform(JAVAEDITION));
