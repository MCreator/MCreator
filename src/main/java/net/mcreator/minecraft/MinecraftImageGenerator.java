...
public class MinecraftImageGenerator {
	...
	public static class Preview {
		...
		/**
		 * <p>This method generates the block icon for chain.</p>
		 *
		 * @param texture <p>Block texture</p>
		 * @return <p>Returns generated image.</p>
		 */
		public static Image generateChainIcon(Image texture) {
			BufferedImage out = new BufferedImage(32, 32, BufferedImage.TYPE_INT_ARGB);
			Graphics2D g2d = (Graphics2D) out.getGraphics();
			g2d.scale(1, 1.15);
			g2d.translate(0, -8);

			g2d.drawImage(ImageUtils.generateCuboidImage(texture, 4, 12, 4, 14, 6, 0), null, null);
			g2d.dispose();
			return out;
		}
