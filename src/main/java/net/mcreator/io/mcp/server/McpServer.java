...
import net.mcreator.io.mcp.protocol.model.JsonRpcRequest;
import net.mcreator.io.mcp.protocol.model.JsonRpcResponse;
import net.mcreator.io.mcp.protocol.model.McpSchema;
import net.mcreator.io.mcp.protocol.schema.JsonSchemaGenerator;
