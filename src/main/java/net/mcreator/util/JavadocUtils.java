...
public final class JavadocUtils {
	...
	public static String formatJavadoc(String docSummary) {
		...
		text = TAG_CODE.matcher(text).replaceAll(
				mr -> Matcher.quoteReplacement("<code>" + StringEscapeUtils.escapeHtml3(mr.group(1)) + "</code>"));
		text = TAG_LINK.matcher(text).replaceAll(
				mr -> Matcher.quoteReplacement("<code>" + StringEscapeUtils.escapeHtml3(mr.group(1)) + "</code>"));
		text = TAG_LINKPLAIN.matcher(text)
				.replaceAll(mr -> Matcher.quoteReplacement(StringEscapeUtils.escapeHtml3(mr.group(1))));
		text = TAG_LITERAL.matcher(text).replaceAll(
				mr -> Matcher.quoteReplacement("<code>" + StringEscapeUtils.escapeHtml3(mr.group(1)) + "</code>"));
		text = TAG_VALUE.matcher(text).replaceAll(
				mr -> Matcher.quoteReplacement("<code>" + StringEscapeUtils.escapeHtml3(mr.group(1)) + "</code>"));

		text = TAG_PARAM_TYPE.matcher(text).replaceAll(mr -> Matcher.quoteReplacement(
				"<br><b>Type Parameters:</b><br>&nbsp;&nbsp;<code>&lt;" + StringEscapeUtils.escapeHtml3(mr.group(1))
						+ "&gt;</code> - "));
		text = TAG_PARAM.matcher(text).replaceAll(mr -> Matcher.quoteReplacement(
				"<br><b>Parameters:</b><br>&nbsp;&nbsp;<code>" + StringEscapeUtils.escapeHtml3(mr.group(1))
						+ "</code> - "));
		text = TAG_RETURN.matcher(text).replaceAll("<br><b>Returns:</b><br>&nbsp;&nbsp;");
		text = TAG_THROWS.matcher(text).replaceAll(mr -> Matcher.quoteReplacement(
				"<br><b>Throws:</b><br>&nbsp;&nbsp;<code>" + StringEscapeUtils.escapeHtml3(mr.group(1))
						+ "</code> - "));
		text = TAG_EXCEPTION.matcher(text).replaceAll(mr -> Matcher.quoteReplacement(
				"<br><b>Throws:</b><br>&nbsp;&nbsp;<code>" + StringEscapeUtils.escapeHtml3(mr.group(1))
						+ "</code> - "));
		text = TAG_SEE.matcher(text).replaceAll(mr -> Matcher.quoteReplacement(
				"<br><b>See Also:</b><br>&nbsp;&nbsp;<code>" + StringEscapeUtils.escapeHtml3(mr.group(1)) + "</code>"));
		text = TAG_SINCE.matcher(text).replaceAll(mr -> Matcher.quoteReplacement(
				"<br><b>Since:</b><br>&nbsp;&nbsp;" + StringEscapeUtils.escapeHtml3(mr.group(1))));
