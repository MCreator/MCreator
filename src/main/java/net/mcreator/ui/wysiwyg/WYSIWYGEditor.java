...
public class WYSIWYGEditor extends JPanel {
	...
	public static final List<WYSIWYGComponentRegistration<?>> COMPONENT_REGISTRY = new ArrayList<>() {{
		...
		add(new WYSIWYGComponentRegistration<>("imagebutton", "addimagebutton", false, ImageButton.class,
				ImageButtonDialog.class));
		...
		add(new WYSIWYGComponentRegistration<>("entity_model", "addmodel", true, EntityModel.class,
				EntityModelDialog.class));
	...
	public WYSIWYGEditor(final MCreator mcreator, boolean isNotOverlayType) {
		...
		adds2.add(PanelUtils.join(FlowLayout.LEFT, L10N.label("elementgui.gui.width_height"), spa1, new JLabel("x"),
				spa2));
