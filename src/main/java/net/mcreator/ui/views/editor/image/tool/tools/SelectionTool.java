...
public class SelectionTool extends AbstractTool {
	...
	public SelectionTool(Canvas canvas, ColorSelector colorSelector, VersionManager versionManager) {
		super(L10N.t("dialog.image_maker.tools.types.select"), L10N.t("dialog.image_maker.tools.types.select_description"),
				UIRES.get("img_editor.select"), canvas, colorSelector, versionManager);
		noSettings(true);
	}
