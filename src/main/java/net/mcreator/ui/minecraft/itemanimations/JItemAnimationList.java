...
public class JItemAnimationList extends JSimpleEntriesList<JItemAnimationListEntry, Item.AnimationEntry> {
	...
	@Override
	protected JItemAnimationListEntry newEntry(JPanel parent, List<JItemAnimationListEntry> entryList,
			boolean userAction) {
		return new JItemAnimationListEntry(mcreator, gui, parent, entryList);
	}
