...
public class JItemAnimationListEntry extends JSimpleListEntry<Item.AnimationEntry> {
	...
	public JItemAnimationListEntry(MCreator mcreator, IHelpContext gui, JPanel parent,
			List<JItemAnimationListEntry> entryList) {
		...
		condition = new ProcedureSelector(gui.withEntry("animations/condition_animation"), mcreator,
				...
				"x:number/y:number/z:number/world:world/itemstack:itemstack/entity:entity")).makeInline();
	...
	@Override public Item.AnimationEntry getEntry() {
		Item.AnimationEntry entry = new Item.AnimationEntry();
	...
	@Override public void setEntry(Item.AnimationEntry e) {
