...
public class AnvilRecipeMaker extends JPanel {
	public MCItemHolder cb1;
	public MCItemHolder cb2;
	public MCItemHolder cb3;

	public AnvilRecipeMaker(MCreator mcreator, MCItem.ListProvider itemsWithTags, MCItem.ListProvider items) {
		ImagePanel ip = new ImagePanel(UIRES.get("recipe.anvil").getImage());
