...
public class JEntityAnimationListEntry extends JSimpleListEntry<LivingEntity.AnimationEntry> {
	...
	public JEntityAnimationListEntry(MCreator mcreator, IHelpContext gui, JPanel parent,
		...
		topLine.add(HelpUtils.wrapWithHelpButton(gui.withEntry("animations/animation"),
				L10N.label("elementgui.animations.animation")));
		topLine.add(animation);

		topLine.add(HelpUtils.wrapWithHelpButton(gui.withEntry("animations/animation_speed"),
		...
		topLine.add(HelpUtils.wrapWithHelpButton(gui.withEntry("animations/animation_amplitude"),
				L10N.label("elementgui.animations.animation_amplitude")));
		topLine.add(amplitude);

		bottomLine.add(HelpUtils.wrapWithHelpButton(gui.withEntry("animations/condition_source"),
				L10N.label("elementgui.animations.animation_condition_source")));
		...
		walking.addActionListener(_ -> amplitude.setEnabled(walking.isSelected()));
