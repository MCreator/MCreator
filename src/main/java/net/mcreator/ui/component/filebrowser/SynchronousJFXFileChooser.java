...
public record SynchronousJFXFileChooser(Stage parent, Supplier<FileChooser> fileChooserFactory) {
	 ...
	 */
	public SynchronousJFXFileChooser {
	}
	...
	public File showOpenDialog() {
		return showDialog(chooser -> chooser.showOpenDialog(parent));
	}
	...
	public File showSaveDialog() {
		return showDialog(chooser -> chooser.showSaveDialog(parent));
	}
	...
	public List<File> showOpenMultipleDialog() {
		return showDialog(chooser -> chooser.showOpenMultipleDialog(parent));
	}
