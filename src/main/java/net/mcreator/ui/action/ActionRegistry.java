...
public class ActionRegistry {
	...
	public ActionRegistry(MCreator mcreator) {
		...
		this.createArmorTexture = new TextureAction(this, L10N.t("action.create_armor_texture"),
				actionEvent -> new ArmorImageMakerView(mcreator).showView(), null).setIcon(UIRES.get("16px.newarmor"));
		...
		this.importEntityTexture = new TextureAction(this, L10N.t("action.import_entity_texture"),
				...
				new ActionAccelerator("import_entity_texture")).setIcon(UIRES.get("16px.importentity"));
		this.importEffectTexture = new TextureAction(this, L10N.t("action.import_effect_texture"),
				...
				new ActionAccelerator("import_effect_texture")).setIcon(UIRES.get("16px.importeffect"));
		this.importParticleTexture = new TextureAction(this, L10N.t("action.import_particle_texture"),
				...
				new ActionAccelerator("import_particle_texture")).setIcon(UIRES.get("16px.importparticle"));
		this.importScreenTexture = new TextureAction(this, L10N.t("action.import_screen_texture"),
				...
				new ActionAccelerator("import_screen_texture")).setIcon(UIRES.get("16px.importgui"));
		...
		}, new ActionAccelerator("import_armor_texture")).setIcon(UIRES.get("16px.importarmor"));
