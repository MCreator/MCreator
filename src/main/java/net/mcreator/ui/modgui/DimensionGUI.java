...
public class DimensionGUI extends ModElementGUI<Dimension> {
	...
	@Override protected void initGUI() {
		...
		portalTexture = new TextureHolder(new TypedTextureSelector(mcreator, TextureType.BLOCK));
		texture = new TextureHolder(new TypedTextureSelector(mcreator, TextureType.ITEM));
