...
public class DimensionGUI extends ModElementGUI<Dimension> {
	...
	@Override protected void initGUI() {
		...
		portalTexture = new TextureHolder(new GeneralTextureSelector(mcreator, TextureType.BLOCK));
		texture = new TextureHolder(new GeneralTextureSelector(mcreator, TextureType.ITEM));
