...
public class BlockGUI extends ModElementGUI<Block> {
	...
	private final JSpinner minGenerateHeight = new JSpinner(new SpinnerNumberModel(-64, -2032, 2016, 1));
	private final JSpinner maxGenerateHeight = new JSpinner(new SpinnerNumberModel(2016, -2032, 2031, 1));
