...
public class FluidGUI extends ModElementGUI<Fluid> {
	...
	@Override protected void initGUI() {
		...
		textureStill = new TextureHolder(new TypedTextureSelector(mcreator, TextureType.BLOCK));
		textureStill.setOpaque(false);
		textureFlowing = new TextureHolder(new TypedTextureSelector(mcreator, TextureType.BLOCK));
		...
		textureBucket = new TextureHolder(new TypedTextureSelector(mcreator, TextureType.ITEM), 32);
