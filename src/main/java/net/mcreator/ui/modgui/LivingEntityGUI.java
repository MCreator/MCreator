...
public class LivingEntityGUI extends ModElementGUI<Mob> {
	...
	@Override protected void initGUI() {
		...
		importmobtexture.addActionListener(e -> {
			...
			mcreator.getFolderManager().getTexturesListFromType("entity").forEach(el -> mobModelTexture.addItem(el.getName()));
			mobModelGlowTexture.removeAllItems();
			mobModelGlowTexture.addItem("");
			mcreator.getFolderManager().getTexturesListFromType("entity").forEach(el -> mobModelGlowTexture.addItem(el.getName()));
		});
