...
public class LivingEntityGUI extends ModElementGUI<LivingEntity> {
	...
	public static final Model[] builtinmobmodels = new Model[] { biped, chicken, cod, cow, creeper, ghast, pig, slime,
	...
	@Override protected void initGUI() {
		...
		importmobtexture.addActionListener(e -> {
			...
			mcreator.getFolderManager().getTexturesList(TextureType.OTHER).forEach(el -> mobModelGlowTexture.addItem(el.getName()));
		});
