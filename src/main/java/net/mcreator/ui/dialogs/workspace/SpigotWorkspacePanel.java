...
public class SpigotWorkspacePanel extends AbstractWorkspacePanel {
	...
	public SpigotWorkspacePanel(Window parent) {
		...
		addAdvancedFormElement(PanelUtils.westAndEastElement(L10N.label("dialog.new_workspace.spigot.plugin_name"),
				workspaceDialogPanel.modID));

		addAdvancedFormElement(new JEmptyBox(10, 10));

		addAdvancedFormElement(PanelUtils.westAndEastElement(L10N.label("dialog.new_workspace.spigot.package"),
				workspaceDialogPanel.packageName));

		addAdvancedFormElement(new JEmptyBox(30, 30));

		addAdvancedFormElement(PanelUtils.westAndEastElement(L10N.label("dialog.new_workspace.spigot.folder"),
