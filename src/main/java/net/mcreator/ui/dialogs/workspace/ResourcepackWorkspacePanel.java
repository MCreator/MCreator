...
public class ResourcepackWorkspacePanel extends AbstractWorkspacePanel {
	...
	public ResourcepackWorkspacePanel(Window parent) {
		...
		addAdvancedFormElement(PanelUtils.westAndEastElement(L10N.label("dialog.new_workspace.resourcepack.modid"),
				workspaceDialogPanel.modID));

		addAdvancedFormElement(new JEmptyBox(30, 30));

		addAdvancedFormElement(PanelUtils.westAndEastElement(L10N.label("dialog.new_workspace.resourcepack.folder"),
