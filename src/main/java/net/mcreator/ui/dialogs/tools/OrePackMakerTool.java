...
public class OrePackMakerTool {
	...
	static MItemBlock addOrePackToWorkspace(MCreator mcreator, Workspace workspace, String name, String type,
		...
		Item oreItem = (Item) ModElementRegistry.BuiltInTypes.ITEM
				.getModElementGUI(mcreator, new ModElement(workspace, oreItemName, ModElementRegistry.BuiltInTypes.ITEM), false)
				.getElementFromGUI();
		oreItem.name = name;
		...
		Block oreBlock = (Block) ModElementRegistry.BuiltInTypes.BLOCK
				.getModElementGUI(mcreator, new ModElement(workspace, name + "Ore", ModElementRegistry.BuiltInTypes.BLOCK), false)
				.getElementFromGUI();
		...
		// we use Block GUI to get default values for the block element (kinda hacky!)
		Block oreBlockBlock = (Block) ModElementRegistry.BuiltInTypes.BLOCK
				.getModElementGUI(mcreator, new ModElement(workspace, name + "Block", ModElementRegistry.BuiltInTypes.BLOCK), false)
				.getElementFromGUI();
		...
		Recipe itemToBlockRecipe = (Recipe) ModElementRegistry.BuiltInTypes.RECIPE
				.getModElementGUI(mcreator, new ModElement(workspace, name + "OreBlockRecipe", ModElementRegistry.BuiltInTypes.RECIPE),
		...
		Recipe blockToItemRecipe = (Recipe) ModElementRegistry.BuiltInTypes.RECIPE
				.getModElementGUI(mcreator, new ModElement(workspace, name + "BlockOreRecipe", ModElementRegistry.BuiltInTypes.RECIPE),
						false).getElementFromGUI();
		...
		Recipe oreSmeltingRecipe = (Recipe) ModElementRegistry.BuiltInTypes.RECIPE
				.getModElementGUI(mcreator, new ModElement(workspace, name + "OreSmelting", ModElementRegistry.BuiltInTypes.RECIPE), false)
				.getElementFromGUI();
		...
		return new BasicAction(actionRegistry, L10N.t("action.pack_tools.ore"),
			...
			@Override public boolean isEnabled() {
				...
				return gc.getGeneratorStats().getModElementTypeCoverageInfo().get(ModElementRegistry.BuiltInTypes.RECIPE)
						...
						&& gc.getGeneratorStats().getModElementTypeCoverageInfo().get(ModElementRegistry.BuiltInTypes.ITEM)
						!= GeneratorStats.CoverageStatus.NONE
