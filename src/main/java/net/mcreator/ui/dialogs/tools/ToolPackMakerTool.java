...
public class ToolPackMakerTool {
	...
	static void addToolPackToWorkspace(MCreator mcreator, Workspace workspace, String name, MItemBlock base,
		...
		FileIO.writeImageToPNGFile(ImageUtils.toBufferedImage(pickaxe.getImage()),
				mcreator.getFolderManager().getTextureFileFromSectionType(RegistryNameFixer.fix(pickaxeTextureName),
						TextureSection.ITEM));
		...
		FileIO.writeImageToPNGFile(ImageUtils.toBufferedImage(axe.getImage()),
				mcreator.getFolderManager().getTextureFileFromSectionType(RegistryNameFixer.fix(axeTextureName),
						TextureSection.ITEM));
		...
		FileIO.writeImageToPNGFile(ImageUtils.toBufferedImage(sword.getImage()),
				mcreator.getFolderManager().getTextureFileFromSectionType(RegistryNameFixer.fix(swordTextureName),
						TextureSection.ITEM));
		...
		FileIO.writeImageToPNGFile(ImageUtils.toBufferedImage(shovel.getImage()),
				mcreator.getFolderManager().getTextureFileFromSectionType(RegistryNameFixer.fix(shovelTextureName),
						TextureSection.ITEM));
		...
		FileIO.writeImageToPNGFile(ImageUtils.toBufferedImage(hoe.getImage()),
				mcreator.getFolderManager().getTextureFileFromSectionType(RegistryNameFixer.fix(hoeTextureName),
						TextureSection.ITEM));
