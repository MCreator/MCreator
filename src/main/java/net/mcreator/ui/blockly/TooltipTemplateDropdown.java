...
public class TooltipTemplateDropdown extends JScrollablePopupMenu {

	private static final Logger LOG = LogManager.getLogger(TooltipTemplateDropdown.class);

	public TooltipTemplateDropdown(BlocklyPanel blocklyPanel, List<ResourcePointer> templatesSorted) {
