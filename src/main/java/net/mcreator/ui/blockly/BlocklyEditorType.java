...
public enum BlocklyEditorType {
	...
	PROCEDURE("procedures", "ptpl", "event_trigger"), AI_TASK("ai_setup", "aitpl", "aitasks_container"),
	COMMAND_ARG("cmd_setup", "cmdtpl", "args_start"), FEATURE("features", "ftpl", "feature_container");
