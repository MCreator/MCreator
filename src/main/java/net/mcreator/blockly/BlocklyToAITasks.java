...
public class BlocklyToAITasks extends BlocklyToJava {

	private static final Logger LOG = LogManager.getLogger("Blockly2AI");

	public BlocklyToAITasks(Workspace workspace, String sourceXML, TemplateGenerator templateGenerator,
