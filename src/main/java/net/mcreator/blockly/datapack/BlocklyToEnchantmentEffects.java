...
public class BlocklyToEnchantmentEffects extends BlocklyToCode {

	private static final Logger LOG = LogManager.getLogger("Blockly2EnchantmentEffects");

	public BlocklyToEnchantmentEffects(Workspace workspace, ModElement parent, String sourceXML,
