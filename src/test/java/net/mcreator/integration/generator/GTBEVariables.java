...
public class GTBEVariables {
	...
	public static void runTest(Logger LOG, String generatorName, Random random, Workspace workspace) {
		...
		String scriptXML = wrapWithBaseTestXML(xml.toString());

		try {
			ModElement modElement = new ModElement(workspace, "TestVariables", ModElementType.BESCRIPT);
			BEScript bescript = new BEScript(modElement);
			bescript.scriptxml = scriptXML;
			...
			fail("[" + generatorName + "] Failed generating variable test script", t);
		}
	}
	...
	private static String wrapWithBaseTestXML(String blocksXML) {
		return """
				<xml xmlns="https://developers.google.com/blockly/xml">
				  <block type="script_trigger" deletable="false" x="20" y="20">
