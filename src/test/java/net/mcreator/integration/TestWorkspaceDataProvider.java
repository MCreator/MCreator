...
public class TestWorkspaceDataProvider {
	...
	private static GeneratableElement getExampleFor(ModElement modElement, Random random, boolean _true,
		...
		if (ModElementType.ADVANCEMENT.equals(modElement.getType())) {
			...
			if (!emptyLists) {
				components.add(
						new Label("text", 100, 150, new StringProcedure(_true ? "string1" : null, "fixed value 1"),
								Color.red, new Procedure("condition1")));
				components.add(
						new Label("text2", 100, 150, new StringProcedure(!_true ? "string2" : null, "fixed value 2"),
								Color.white, new Procedure("condition4")));
				...
				new InputSlot(5, "slot5", 20, 30, Color.white, new LogicProcedure("condition1", true),
						...
						getRandomMCItem(random, blocksAndItems).getName()));
				components.add(
						new InputSlot(4, "slot3", 20, 30, Color.green, new LogicProcedure(null, true),
				...
				components.add(
						new OutputSlot(5, "slot out", 10, 20, Color.black, new LogicProcedure("condition2", true),
								_true, new Procedure("procedure10"),
								new Procedure("procedure2"), new Procedure("procedure3")));
				components.add(new OutputSlot(6, "sot", 243, 563, Color.black, new LogicProcedure("condition2", true),
