...
public class TestWorkspaceDataProvider {
	...
	public static List<GeneratableElement> getModElementExamplesFor(ModElement modElement, Random random) {
		...
		} else if (modElement.getType() == ModElementType.TOOL) {
			generatableElements.add(getToolExample(modElement, "Pickaxe", random, false, false));
			generatableElements.add(getToolExample(modElement, "Pickaxe", random, true, false));
			generatableElements.add(getToolExample(modElement, "Pickaxe", random, false, true));
			generatableElements.add(getToolExample(modElement, "Pickaxe", random, true, true));
			generatableElements.add(getToolExample(modElement, "Axe", random, true, false));
			generatableElements.add(getToolExample(modElement, "Sword", random, true, false));
			generatableElements.add(getToolExample(modElement, "Spade", random, true, false));
			generatableElements.add(getToolExample(modElement, "Hoe", random, true, false));
			generatableElements.add(getToolExample(modElement, "Special", random, true, false));
			generatableElements.add(getToolExample(modElement, "Special", random, false, false));
			generatableElements.add(getToolExample(modElement, "MultiTool", random, true, false));
			generatableElements.add(getToolExample(modElement, "MultiTool", random, false, false));
			generatableElements.add(getToolExample(modElement, "Shears", random, true, false));
			generatableElements.add(getToolExample(modElement, "Shears", random, false, false));
	...
	public static void fillWorkspaceWithTestData(Workspace workspace) {
		...
		workspace.addModElement(new ModElement(workspace, "procedure2", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure3", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure4", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure5", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure6", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure7", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure8", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure9", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure10", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure11", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure12", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));
		workspace.addModElement(new ModElement(workspace, "procedure13", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()));

		workspace.addModElement(new ModElement(workspace, "condition1", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()).putMetadata("return_type", "LOGIC"));
		workspace.addModElement(new ModElement(workspace, "condition2", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()).putMetadata("return_type", "LOGIC"));
		workspace.addModElement(new ModElement(workspace, "condition3", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()).putMetadata("return_type", "LOGIC"));
		workspace.addModElement(new ModElement(workspace, "condition4", ModElementType.PROCEDURE)
				.putMetadata("dependencies", new ArrayList<String>()).putMetadata("return_type", "LOGIC"));
	...
	private static GeneratableElement getExampleFor(ModElement modElement, Random random, boolean _true,
		...
		case ACHIEVEMENT:
			...
			achievement.parent = new AchievementEntry(modElement.getWorkspace(),
					ListUtils.getRandomItem(random, ElementUtil.loadAllAchievements(modElement.getWorkspace())));
		...
		case BIOME:
			...
			biome.bamboosPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 3;
			biome.flowersPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 4;
			biome.doubleFlowersPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 5;
			biome.mushroomsPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 6;
			biome.bigMushroomsChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 7;
			biome.sandPathcesPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 8;
			biome.gravelPatchesPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 9;
			biome.reedsPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 10;
			biome.pumpkinsPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 11;
			biome.cactiPerChunk = new int[] { 0, 5, 10, 16 }[valueIndex] + 12;
			...
			if (!emptyLists) {
				...
				entry1.entity = new EntityEntry(modElement.getWorkspace(),
						ListUtils.getRandomItem(random, ElementUtil.loadAllEntities(modElement.getWorkspace())));
				entry1.minGroup = 10;
				entry1.minGroup = 134;
				entry1.weight = 13;
		...
		case OVERLAY:
			...
			overlay.priority = ListUtils
					.getRandomItem(random, new String[] { "NORMAL", "HIGH", "HIGHEST", "LOW", "LOWEST" });
			...
			if (!emptyLists) {
				...
				components
						.add(new InputSlot(4, "slot2", 20, 30, Color.white, !_true, !_true, new Procedure("procedure4"),
								null, null, new MItemBlock(modElement.getWorkspace(), ListUtils
				...
				components.add(new TextField("text1", 55, 231, 90, 20, ""));
			}
		...
		case MOB:
			...
			mob.mobModelName = ListUtils.getRandomItem(random, LivingEntityGUI.builtinmobmodels).getReadableName();
			mob.spawnEggBaseColor = Color.red;
			mob.spawnEggDotColor = Color.green;
			mob.isBoss = _true;
			mob.creativeTab = new TabEntry(modElement.getWorkspace(),
					ListUtils.getRandomItem(random, ElementUtil.loadAllTabs(modElement.getWorkspace())));
			mob.bossBarColor = ListUtils.getRandomItem(random,
					new String[] { "PINK", "BLUE", "RED", "GREEN", "YELLOW", "PURPLE", "WHITE" });
			mob.bossBarType = ListUtils.getRandomItem(random,
		...
		case DIMENSION:
			...
			dimension.enablePortal = !emptyLists;
		...
		case STRUCTURE:
			...
			structure.surfaceDetectionType = ListUtils
					.getRandomItem(random, Arrays.asList("First motion blocking block", "First block"));
			structure.ignoreBlocks = ListUtils
					.getRandomItem(random, Arrays.asList("STRUCTURE_BLOCK", "AIR_AND_STRUCTURE_BLOCK", "AIR"));
		...
		case PLANT:
			...
			plant.creativePickItem = new MItemBlock(modElement.getWorkspace(),
					ListUtils.getRandomItem(random, ElementUtil.loadBlocks(modElement.getWorkspace())).getName());
			plant.colorOnMap = ListUtils.getRandomItem(random, ElementUtil.loadMapColors());
			plant.offsetType = ListUtils.getRandomItem(random, Arrays.asList("NONE", "XZ", "XYZ"));
			plant.aiPathNodeType = ListUtils.getRandomItem(random, ElementUtil.loadPathNodeTypes());
			plant.unbreakable = _true;
			plant.soundOnStep = new StepSound(modElement.getWorkspace(),
					ListUtils.getRandomItem(random, ElementUtil.loadStepSounds()));
		...
		case BLOCK:
			...
			block.reactionToPushing = ListUtils
					.getRandomItem(random, new String[] { "NORMAL", "DESTROY", "BLOCK", "PUSH_ONLY", "IGNORE" });
			...
			block.material = new Material(modElement.getWorkspace(),
					ListUtils.getRandomItem(random, ElementUtil.loadMaterials()));
			block.tickRate = 24;
			...
			block.creativePickItem = new MItemBlock(modElement.getWorkspace(),
					ListUtils.getRandomItem(random, ElementUtil.loadBlocks(modElement.getWorkspace())).getName());
			block.colorOnMap = ListUtils.getRandomItem(random, ElementUtil.loadMapColors());
			block.offsetType = ListUtils.getRandomItem(random, Arrays.asList("NONE", "XZ", "XYZ"));
			block.aiPathNodeType = ListUtils.getRandomItem(random, ElementUtil.loadPathNodeTypes());
			if (!emptyLists)
			...
			if (!emptyLists) {
				block.fluidRestrictions.add(new net.mcreator.element.parts.Fluid(modElement.getWorkspace(),
						ListUtils.getRandomItem(random, ElementUtil.loadAllFluids(modElement.getWorkspace()))));
				block.fluidRestrictions.add(new net.mcreator.element.parts.Fluid(modElement.getWorkspace(),
						ListUtils.getRandomItem(random, ElementUtil.loadAllFluids(modElement.getWorkspace()))));
			}
		...
		case LOOTTABLE:
			...
			lootTable.namespace = ListUtils.getRandomItem(random, new String[] { "minecraft", "mod" });
			lootTable.type = ListUtils.getRandomItem(random,
		...
		case FUNCTION:
			...
			function.namespace = ListUtils.getRandomItem(random, new String[] { "minecraft", "mod" });
		...
		case ENCHANTMENT:
			...
			enchantment.rarity = ListUtils
					.getRandomItem(random, new String[] { "COMMON", "UNCOMMON", "RARE", "VERY_RARE" });
			enchantment.type = ListUtils.getRandomItem(random,
			...
			if (!emptyLists) {
				enchantment.compatibleEnchantments
						.add(new net.mcreator.element.parts.Enchantment(modElement.getWorkspace(), ListUtils
