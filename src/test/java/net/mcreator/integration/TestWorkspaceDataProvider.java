...
public class TestWorkspaceDataProvider {
	...
	private static GeneratableElement getExampleFor(ModElement modElement, Random random, boolean _true,
		...
		if (ModElementType.ADVANCEMENT.equals(modElement.getType())) {
			...
			components.add(new EntityModel(60, 20, new Procedure("entity1"), new Procedure("condition3"), 30, 0, 90, false));
			components.add(new EntityModel(60, 20, new Procedure("entity1"), new Procedure(!_true ? "condition4" : null), 30, 90, 180,false));
			...
			if (!emptyLists) {
				...
				components.add(new EntityModel(60, 20, new Procedure("entity1"), new Procedure("condition3"), 30, 0, 90, _true));
				components.add(new EntityModel(60, 20, new Procedure("entity1"), new Procedure(!_true ? "condition4" : null), 30, 12, 270, !_true));
			}
