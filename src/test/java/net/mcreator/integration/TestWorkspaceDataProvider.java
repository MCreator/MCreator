...
public class TestWorkspaceDataProvider {
	...
	private static GeneratableElement getExampleFor(ModElement modElement, Random random, boolean _true,
		...
		if (ModElementType.ADVANCEMENT.equals(modElement.getType())) {
			...
			components.add(new EntityModel(60, 20, new Procedure("procedure1"), new Procedure("condition3"), 30));
			...
			if (!emptyLists) {
				...
				components.add(new EntityModel(60, 20, new Procedure("procedure1"), new Procedure("condition1"), 30));
			}
