...
public class TestWorkspaceDataProvider {
	...
	private static GeneratableElement getExampleFor(ModElement modElement, Random random, boolean _true,
		...
		if (ModElementType.ADVANCEMENT.equals(modElement.getType())) {
			...
			if (!emptyLists) {
				biomeDictTypes.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDictTypes.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDictTypes.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDictTypes.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDictTypes.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
			...
			if (!emptyLists) {
				biomeDefaultFeatures.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDefaultFeatures.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDefaultFeatures.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDefaultFeatures.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
				biomeDefaultFeatures.add(getRandomItem(random, ElementUtil.loadDataList("defaultfeatures")));
			...
			fluid.colorOnMap = getRandomItem(random, ElementUtil.loadDataList("mapcolors"));
			...
			if (_true) {
				...
				overlay.overlayTarget = getRandomItem(random, ElementUtil.loadDataList("screens"));
			}
			return overlay;
			...
			plant.growapableSpawnType = getRandomItem(random, ElementUtil.loadDataList("planttypes"));
			...
			plant.creativePickItem = new MItemBlock(modElement.getWorkspace(),
					getRandomMCItem(random, ElementUtil.loadBlocks(modElement.getWorkspace())).getName());
			plant.colorOnMap = getRandomItem(random, ElementUtil.loadDataList("mapcolors"));
			plant.offsetType = getRandomString(random, Arrays.asList("NONE", "XZ", "XYZ"));
			plant.aiPathNodeType = getRandomItem(random, ElementUtil.loadDataList("pathnodetypes"));
			...
			block.creativePickItem = new MItemBlock(modElement.getWorkspace(),
					getRandomMCItem(random, ElementUtil.loadBlocks(modElement.getWorkspace())).getName());
			block.colorOnMap = getRandomItem(random, ElementUtil.loadDataList("mapcolors"));
			block.offsetType = getRandomString(random, Arrays.asList("NONE", "XZ", "XYZ"));
			block.aiPathNodeType = getRandomItem(random, ElementUtil.loadDataList("pathnodetypes"));
			if (!emptyLists)
