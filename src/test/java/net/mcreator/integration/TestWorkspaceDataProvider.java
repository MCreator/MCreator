...
public class TestWorkspaceDataProvider {
	...
	private static GeneratableElement getExampleFor(ModElement modElement, boolean uiTest, Random random, boolean _true,
		...
		if (ModElementType.ADVANCEMENT.equals(modElement.getType())) {
			...
			plant.xpAmountMin = 2;
			plant.xpAmountMax = 5;
			plant.blockBounciness = new NumberProcedure(emptyLists ? null : "number1", 1);
			plant.fallDamageInduced = new NumberProcedure(emptyLists ? null : "number2", 5);
	...
	private static GeneratableElement getBlockExample(ModElement modElement, Random random, boolean _true,
		...
		block.blockBounciness = new NumberProcedure(emptyLists ? null : "number2", 1);
		block.fallDamageInduced = new NumberProcedure(emptyLists ? null : "number3", 5);
